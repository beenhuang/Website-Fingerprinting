...
def main(X, y):
    ...
    CLASSES = 101
    # create DFNet model    
    model = AWFNet(CLASSES).to(device)     
    # loss function    
...
def test(test_dataloader, model, device, classes):
