...
from tiktok_feature.dt_feature import dt_feature
...
def extract(data_dir, feature_dir, file, umon_label=100):
    ...
    # directional-timing feature
    feature = dt_feature(good_trace)
...
if __name__ == "__main__":
    ...
    MAIN_FEATURE_DIR = join(BASE_DIR, "attack", "tiktok", "feature")
