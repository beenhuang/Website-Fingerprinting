...
from classifier.convnet import ConvNet
from classifier.dfnet import DFNet
...
def main(X, y, result_path):
    ...
    model = ConvNet.build(NB_CLASSES,INPUT_SHAPE)
    ...
    # get metrics value
    lines = df_openworld(y_test, y_pred)
