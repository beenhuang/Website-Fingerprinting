...
def train_test_dataloader(X, y, test_size=0.2, batch_size=2048):
...
def train_valid_test_dataloader(X, y, valid_size=0.1, test_size=0.1, batch_size=128):
    ...
    X_valid, X_test, y_valid, y_test = train_test_split(X_valid_test, y_valid_test, test_size=test_size/(valid_size+test_size), random_state=247, stratify=y_valid_test)
...
if __name__ == '__main__':
    ...
    train_dataloader, valid_dataloader, test_dataloader = train_valid_test_dataloader(X, y)
