...
# packet_size <= max_packet_size of dynaflow function
def preprocess(trace, packet_size=512):
    ...
    for e in trace:
        ...
        good_trace.append([time, direction, packet_size])
...
def defend(data_dir, defended_dir, file):
    ...
    dyna_trace = dynaflow(good_trace)
...
if __name__ == "__main__":
    ...
    MAIN_DEFENDED_DIR = join(BASE_DIR, "data", "dynaflow")
