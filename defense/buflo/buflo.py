...
# query_data format: [[index, time, size, direction] ...]
def buflo_ordered(query_data, d=1500, f=50, t=100):
    '''
    apply BuFlo countermeasure to traffic data. In BuFlo, it will send a packet of length d every ρ milliseconds until
    ...
    # convert to [[time, direction] ...] format.
    new_trace = [[float(x[1]), int(x[3])] for x in query_data]
